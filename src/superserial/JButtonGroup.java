...
public class JButtonGroup extends ButtonGroup {
    ...
    /**
     * A method added for only my use,
     * not efficient at all but it works with menuItems
     * @return String name of the active button/menuItem
     */
    public String getSelectedName(){
        Enumeration<AbstractButton> buttonenum=buttons.elements();
        String selectedString=null;
        while(buttonenum.hasMoreElements()){
            AbstractButton b=buttonenum.nextElement();
            if(b.isSelected()){
                selectedString=b.getText();
            }
        }
